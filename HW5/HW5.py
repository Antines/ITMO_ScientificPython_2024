...
Original file is located at
    https://colab.research.google.com/drive/15B46QeIFUclPA5H8SS_Igba5GG4F6UWt
...
#import sys
#sys.path.append('/content/drive/MyDrive/hw5_data')
...
def fit_Ridge(X_train, X_test, y_train, y_test):
    ...
    parameters = {
        'anova__k': [5, 10, 20, 40],
        'rf__alphas': [[0.1, 1.0, 10.0], [0.01, 0.1, 1.0, 10.0, 100.0]]}
...
def desc_calc(data: pd.DataFrame, mode = "Train") -> pd.DataFrame:
    return getAllDescriptors(data)
...
def sar_model_predict(model, descriptors_pred, indices):
    ...
    X_pred = descriptors_pred.drop(columns=['Target'])
...
if __name__ == "__main__":
    ...
    # loading data
    train_data = pd.read_csv('/content/drive/MyDrive/hw5_data/logp_100.csv')
    pred_data = pd.read_csv('/content/drive/MyDrive/hw5_data/logp_inputs.csv')
    ...
    pred_descriptors['SMILES'] = pred_data['SMILES']
    for cpd in cpds:
